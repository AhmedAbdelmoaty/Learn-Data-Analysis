...
<section class="topic-hero py-5" style="background: linear-gradient(rgba(168, 50, 78, 0.7), rgba(108, 30, 53, 0.7)), url('<?php echo htmlspecialchars($hero_section['image'] ?: ($settings['hero_background'] ?? 'https://via.placeholder.com/1920x600')); ?>'); background-size: cover; background-position: center;">
    <div class="container">
