...
<!-- Topic Hero -->
<section class="topic-hero py-5" style="background: linear-gradient(rgba(156, 39, 176, 0.8), rgba(123, 31, 162, 0.8)), url('<?php echo htmlspecialchars($topic['hero_image']); ?>'); background-size: cover; background-position: center;">
    <div class="container">
