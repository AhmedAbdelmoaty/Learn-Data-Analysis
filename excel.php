...
<!-- Topic Hero -->
<section class="topic-hero py-5" style="background: linear-gradient(rgba(76, 175, 80, 0.8), rgba(56, 142, 60, 0.8)), url('<?php echo htmlspecialchars($topic['hero_image']); ?>'); background-size: cover; background-position: center;">
    <div class="container">
